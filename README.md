...
**Squid** - A better open-source AI chatbot for individuals and teams, inspired by ChatGPT, Claude, Grok, and Gemini.
...
Step-by-step setup guides for running and configuring squid.
...
Planned features coming soon to squid:
